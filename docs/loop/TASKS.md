...
- active: none
- ready: none
- blocked: G0 / GitHub #9 until the #15 correction follow-up is approved and resolved
- terminal: false
...
G0 requires the bounded static-calibration follow-up drafted by #15 to be approved,
created, and resolved, plus approved production deployment, analytics, and real
